...
1) Increased **FORCE** produces **MOTION** in **MASS** resulting in **ACCELERATION**. 
2) If a **MASS** is not driven by **FORCE**, then there is no **ACCELERATION**.
3) **MASS** can exist without **FORCE**, but there will be no **MOMENTUM** or **ACCELERATION** without **FORCE**.
...
6) Changes in **MASS** (due to **FORCE**) in **VELOCITY** (relative to the market) is the lasting equilibriated effect.
